...
<body>
    ...
    <h1 class="news">
        ...
        <?php
            ...
            echo "<img src=\"../images/$imgName\" title=\"$imgName\"/ alt=\"$imgName\" height=\"420.77\" width=\"800\"/>";
        ?>
    </h1>
    <div>
        <p>
        ...
        <?php
            $imgName = "videogames_2.jpg";
            echo "<img class=\"imagenes-secundarias\" src=\"../images/$imgName\" title=\"$imgName\"/ alt=\"$imgName\"/>";
        ?>
        <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti reprehenderit doloribus
            aspernatur cum? Dolorum, expedita necessitatibus fugiat et obcaecati iusto magni modi.
    ...
    <footer class="footer"><h2>PC Gamer</h2></footer>
